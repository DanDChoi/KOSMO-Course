...
public class Mine_Login extends JFrame implements ActionListener {
	...
	public void init() {
		...
		tf_nickName.setBorder(new LineBorder(Color.BLACK, 2));
		tf_nickName.setForeground(Color.BLACK);
		tf_nickName.setBackground(new Color(255, 255, 255));
		tf_Ip.setBorder(new LineBorder(Color.BLACK, 2));
