...
class CM_Client extends JFrame implements ActionListener
{
   ...
   public CM_Client(){
      ...
      panel_ClientList.setBorder(new LineBorder(new Color(255, 164, 38), 4, true)); //setborder 직선보더,컬러굵기
      ...
      label_Exam = new JLabel(new ImageIcon("image\\exam.png")); // //문제라고 적힌 그림
