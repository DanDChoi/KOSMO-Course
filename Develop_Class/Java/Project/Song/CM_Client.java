...
class CM_Client extends JFrame implements ActionListener
{
   ...
   JLabel label_Canvas, label_Exam, label_Exam_Sub, label_Timer, label_Client1, label_Client2, label_Client3, label_Client4 , 
	   label_Flag1 , label_Flag2, label_Flag3, label_Flag4, label_MineBack;
   ...
   public CM_Client(){
      ...
      panel_ClientList.setBounds(0, 105, 300, 500);
      label_ClientList.setBounds(-75, 105, 312, 500);
	  label_ClientList1.setBounds(65, 105, 312, 500);
      ...
      panel_ClientList.add(label_Flag1);
      ...
      panel_ClientList.add(label_Flag2);
      ...
      panel_ClientList.add(label_Flag3);
      ...
      panel_ClientList.add(label_Flag4);
      ...
      label_Client1_Sub = new Label("[ 닉네임 ]");
      ...
      label_Client2_Sub = new Label("[ 닉네임 ]");
      ...
      label_Client3_Sub = new Label("[ 닉네임 ]");
      ...
      label_Client4_Sub = new Label("[ 닉네임 ]");
      ...
      JLabel label_Exam_Back = new JLabel(new ImageIcon("image\\topbg.png")); // 위에 하늘색
      label_Exam_Back.setOpaque(true);// 배경색 설정
      label_Exam_Back.setBounds(0, 0, 1245, 85);
      panel_Exam.add(label_Exam_Back);
      panel_Exam.setLayout(null);
      
      label_Exam = new JLabel(new ImageIcon("image\\toplogo.png")); // //문제라고 적힌 그림
      label_Exam.setOpaque(false);
      label_Exam.setBounds(315, 10, 700, 85);
...
/*
			...
			panel_Time_back.setBounds(0, 0, 158, 57);		
			panel_Time_back.setOpaque(true);
			label_Timer = new JLabel("00 : 00");
			label_Timer.setBounds(0, 0, 158, 57);
			label_Timer.setFont(new Font("나눔바른고딕", Font.PLAIN, 24));
