 ...
 * Generated at: 2022-01-24 06:06:57 UTC
...
ResultSet rs = null;
		...
		try {
			...
			while (rs.next()) {
				...
				pw.println("<tr>");
					pw.println("<td align='center'><%=sqe
      out.write("</td>\");\r\n");
      out.write("					pw.println(\"<td align='center'>");
      out.print(name);
      out.write("</td>\");\r\n");
      out.write("					pw.println(\"<td align='center'>");
      out.print(email);
      out.write("</td>\");\r\n");
      out.write("					pw.println(\"<td align='center'><a href='content.do?seq=");
      out.print(sqe);
      out.write('\'');
      out.write('>');
      out.print(subject);
      out.write("</a></td>\");\r\n");
      out.write("					pw.println(\"<td>");
      out.print(rdate);
      out.write("</td>\");\r\n");
      out.write("				pw.println(\"</tr>\");\r\n");
      out.write("			}\r\n");
      out.write("		} catch (SQLException se) {\r\n");
      out.write("			System.out.println(\"#service() se: \" + se);\r\n");
      out.write("		} finally {\r\n");
      out.write("			try {\r\n");
