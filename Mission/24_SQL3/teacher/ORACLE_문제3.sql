...
(7) 전체 사원의 평균임금보다 많은 사원의 사원번호, 이름, 부서명, 입사일, 지역, 
    급여를 출력하라. 
    select e.EMPNO "사원번호", e.ENAME "이름", d.DNAME "부서명", e.HIREDATE "입사일", d.LOC "지역", e.SAL "급여"from EMP e, DEPT d
...
(8) 10번 부서 사람들 중에 20번 부서의 사원과 같은 업무를 하는 사원의 사원번호, 
    ...
    select e.EMPNO "사원번호", e.JOB "업무", e.ENAME "이름", d.DNAME "부서명", HIREDATE "입사일", d.LOC "지역"
    from EMP e, DEPT d 
...
(10) 10번 부서와 같은 일을 하는 사원의 사원번호, 업무, 이름, 부서번호, 부서명, 
   지역, 급여를 급여가 많은 순으로 출력하라.
    select e.EMPNO "사원번호", e.JOB "업무", e.ENAME "이름", e.DEPTNO "부서번호", d.DNAME "부서명", HIREDATE "입사일", d.LOC "지역", e.SAL "급여"
    from EMP e, DEPT d 
