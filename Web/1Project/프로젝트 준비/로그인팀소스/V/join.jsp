...
<center>
   ...
   <form name="input" action="togather/login.do?m=join" method="post">
       <table border="1" width="300" height="200">
	      ...
	      <tr>
			 ...
			 <td align="center"><input type="text" name="mname" size="60" onkeydown="enterCheck(this)" value="이름을 싸즈세여" disabled></td>
		  </tr>	   
		  <tr>
