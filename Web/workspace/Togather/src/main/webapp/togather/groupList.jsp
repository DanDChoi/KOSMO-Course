...
<h2>모임목록</h2>
&nbsp;&nbsp;&nbsp;
<a href="togather.do?m=groupCreate">모임 만들기</a>
&nbsp;&nbsp;&nbsp;
<a href="../">인덱스</a>
<hr width='600' size='2' noshade>
</center>
...
<c:forEach items="${groupList}" var="groupTab">
			<tr>
				<td align='center'>${groupTab.gSeq}</td>
				<td align='center'>${groupTab.gAddr}</td>
				<td align='center'>${groupTab.limit}</td>
				<td align='center'>
				<a href='board.do?m=content&seq=${groupTab.gSeq}'>${groupTab.gName}</a></td>
				<td>${groupTab.rdate}</td>
			</tr>
</c:forEach>   
