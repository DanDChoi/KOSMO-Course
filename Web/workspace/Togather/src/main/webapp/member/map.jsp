...
<script src="//dapi.kakao.com/v2/maps/sdk.js?appkey=27908d2c188bdaa60d7241b7783dbf68&libraries=services"></script>
<script>
 ...
 geocoder.addressSearch(gap, function(result, status) {
  ...
  if (status == daum.maps.services.Status.OK) {
   ...
   var infowindow = new daum.maps.InfoWindow({
    content: '<div style="width:150px;text-align:center;padding:5px 0;">내 위치</div>'
   });
