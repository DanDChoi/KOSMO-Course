      ...
      <div class="container px-2 px-lg-2">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          ...
          <form class="d-flex">
            ...
            if(userid==null){    
            %>
            <button class="btn btn-outline-dark" type="button" onclick="location.href='javascript:f_login()' ">
              <i class="bi bi-person-fill"></i>
              로그인
            </button>
             <button class="btn btn-outline-dark" type="button" onclick="location.href='javascript:f_join()'">
              <i class="bi bi-person-plus-fill"></i>
              회원가입
            </button>
           <% }else {%>
            <button id = "logout" class="btn btn-outline-dark" type="button" onclick="location.href='javascript:signout()'">
              <i class="bi bi-person-fill"></i>
              로그아웃
            </button>
           
      		<%}%>
            <button class="btn btn-outline-dark" type="button" onclick="location.href='javascript:sendLinkCustom()'">
              <i class="bi bi-person-fill"></i>
              카톡공유하기
            </button>
            <% int wlistSize = 0;
            ...
            <button class="btn btn-outline-dark" type="button" onclick="location.href='group/groupTab.do?m=wishlist&userid=<%=userid%>&usermnum=${usermnum}'">
              <i class="bi-cart-fill me-1"></i>
              찜
              <span class="badge bg-dark text-white ms-1 rounded-pill"><%=wlistSize%></span>
            </button> 
            </c:if>
            <button class="btn btn-outline-danger" type="button" onclick="location.href='group/groupTab.do?m=groupInput&userid=<%=userid%>'">
              <i class="bi bi-people-fill"></i>
              모임 만들기
            </button>
            <button class="btn btn-outline-dark" type="button" onclick="location.href='board/board.do' ">
              <i class="bi bi-person-fill"></i>
             	자유게시판
            </button>
          </form>
