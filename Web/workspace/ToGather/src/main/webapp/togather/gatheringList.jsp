...
<table border='1' width='600' align='center' cellpadding='2'>
	<tr>
		...
		<th align='center' width='15%'>정모 시간</th>
		<th align='center' width='15%'>정모 장소</th>
		<th align='center' width='20%'>정모 비용</th>
		<th align='center' width='20%'>정모 정원</th>
	</tr>
	...
	<c:forEach items="${gatheringList}" var="gathering">
		<tr>
			<td align='center'><a href="groupTab.do?m=gatheringList&gSeq=${gathering.gSeq}">${gathering.gt_name}</a></td>
			<td align='center'>${gathering.gt_date}</td>
			<td align='center'>${gathering.time}</td>
			<td align='center'>${gathering.gt_place}</td>
			<td align='center'>${gathering.price}</td>
			<td align='center'>${gathering.gt_limit}</td>
		</tr>
	</c:forEach>
</table>
<hr width='600' size='2' noshade>
